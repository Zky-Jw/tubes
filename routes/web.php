...
use App\Http\Controllers\KodeRakController;
...
use App\Http\Controllers\LaporanKotakSaranController;
use App\Http\Controllers\LaporanOrderBarangController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => 'checkRole:superadmin,manajer'], function () {
        Route::resource('/aktivitas-user', ActivityLogController::class);
    });


    Route::group(['middleware' => 'checkRole:manajer,superadmin,operator'], function () {
        ...
        Route::get('/laporan-kategori/get-data', [LaporanKategoriController::class, 'getData']);
        Route::get('/laporan-kategori', [LaporanKategoriController::class, 'index']);
        Route::get('/laporan-kategori/print-kategori', [LaporanKategoriController::class, 'printKategori']);
        ...
        Route::get('/laporan-kotak-saran/get-data', [LaporanKotakSaranController::class, 'getData']);
        Route::get('/laporan-kotak-saran', [LaporanKotakSaranController::class, 'index']);
        Route::get('/laporan-kotak-saran/print-kotak-saran', [LaporanKotakSaranController::class, 'printKotakSaran']);

        Route::get('/laporan-order-barang/get-data', [LaporanOrderBarangController::class, 'getData']);
        Route::get('/laporan-order-barang', [LaporanOrderBarangController::class, 'index']);
        Route::get('/laporan-order-barang/print-order-barang', [LaporanOrderBarangController::class, 'printOrderBarang']);
    ...
    Route::group(['middleware' => 'checkRole:superadmin,operator'], function () {
        ...
        Route::get('/rak/get-data', [KodeRakController::class, 'getDataKodeRak']);
        Route::resource('/rak', KodeRakController::class);
        ...
        Route::get('/api/daftar_barang', [BarangMasukController::class, 'daftarBarang']);
        ...
        Route::get('/api/daftar_barang', [BarangKeluarController::class, 'daftarBarang']);
        Route::get('/api/satuan/', [BarangKeluarController::class, 'getSatuan']);
        Route::resource('/barang-keluar', BarangKeluarController::class);

        Route::get('/kotak-saran/get-data', [KotakSaranController::class, 'getDataKotakSaran']);
        Route::resource('/kotak-saran', KotakSaranController::class);

        Route::get('/order-barang/get-data', [OrderBarangController::class, 'getDataOrderBarang']);
        Route::resource('/order-barang', OrderBarangController::class);
    });
});
