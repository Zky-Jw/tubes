...
<div class="modal fade" role="dialog" id="modal_edit_barang_masuk" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" id="form_edit_barang_masuk">
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" id="barang_masuk_id">
                        <div class="col-lg-6">
                            <div class="col-md-12">
                                <label for="kode_transaksi">Kode Transaksi (<i>Contoh JO - 027 - PT</i>)</label>
                ...
                <div class="modal-footer mt-3">
                    ...
                    <button type="button" class="btn btn-primary" onclick="updateBarangMasuk()">Update</button>
                </div>
            </form>
        </div>
    </div>
