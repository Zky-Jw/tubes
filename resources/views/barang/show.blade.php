                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rak_id" id="detail_rak_id" disabled>
                                    @foreach ($raks as $rak)
                                        @if (old('rak', $rak->raks) == $rak->id)
                                            <option value="{{ $rak->id }}" selected>{{ $rak->kd_rak }} -
                                                {{ $rak->nm_rak }}</option>
                                        @else
                                            <option value="{{ $rak->id }}">{{ $rak->kd_rak }} -
                                                {{ $rak->nm_rak }}</option>
                                        @endif
                                    @endforeach
                                </select>
