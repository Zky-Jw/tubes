...
@section('content')
    <div class="section-header">
        ...
        <div class="ml-auto">
            <a href="javascript:void(0)" class="btn btn-danger" id="print-order-barang"><i
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        <form id="filter_form" action="/laporan-order-barang/get-data" method="GET">
                            <div class="row">
                                <div class="col-md-5">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table_id" class="display">
                            ...
                            <tbody id="tabel-laporan-order-barang">
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData() {
                ...
                $.ajax({
                    url: '/laporan-order-barang/get-data',
                    type: 'GET',
                    dataType: 'json',
                    data: {
            ...
            // Print Kotak Saran
            $('#print-order-barang').on('click', function() {
                var tanggalMulai = $('#tanggal_mulai').val();
                var tanggalSelesai = $('#tanggal_selesai').val();

                var url = '/laporan-order-barang/print-order-barang';
